...
export type TSolXenMiner = {
  ...
  instructions: [
        ...
        },
        {
          ...
          pda: {
            seeds: [
              {
                kind: 'const';
                value: [120, 110, 45, 109, 105, 110, 101, 114, 45, 103, 108, 111, 98, 97, 108];
              },
              {
                kind: 'arg';
                path: 'kind';
    ...
    {
      name: 'mineHashes';
      discriminator: [192, 6, 168, 29, 123, 183, 150, 48];
      accounts: [
        {
          name: 'globalXnRecord';
          writable: true;
...
export type TSolXenMinter = {
        ...
        },
        {
          ...
          pda: {
            seeds: [
              {
                kind: 'const';
                value: [115, 111, 108, 45, 120, 101, 110, 45, 109, 105, 110, 116, 101, 100];
              },
              {
                kind: 'account';
                path: 'user';
  ...
  accounts: [
    {
      name: 'userTokensRecord';
      discriminator: [113, 218, 188, 234, 62, 173, 78, 230];
    }
  ];
  errors: [
    {
