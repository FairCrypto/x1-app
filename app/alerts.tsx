...
const AlertInstance = ({ alert, onActionClick, removeAlert }) => (
  <Alert
    ...
    sx={{
      ...
      color: theme =>
        theme.palette.getContrastText(theme.palette.mode === 'light' ? '#A9A9A9' : '#808080'),
      display: 'flex',
      alignItems: 'center'
    }}
    action={
          ...
          <Button
            ...
            sx={{
              backgroundColor: theme =>
                theme.palette.mode === 'light' ? theme.palette.grey.A700 : theme.palette.grey.A200,
              margin: 0
            }}
            size="small"
...
const Alerts = () => {
  ...
  return (
    <Stack direction="column" spacing={0}>
      {notifications.alerts.map((alert: any) => (
        <AlertInstance
          key={alert.key}
          alert={alert}
