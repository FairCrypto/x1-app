...
const networkConfigs = ({ config = {} }: NextConfig): Record<string, TNetworkConfig> => ({
  ...
  bsc: {
    ...
    rpcURL:
      arrayOrString(config.rpcUrlOverrides?.bsc) ||
      'https://cosmopolitan-dark-patron.bsc.quiknode.pro/8a6506a7323756d706402c89b29ae340adde9456/',
  ...
  polygon: {
    ...
    safeMaxVMUs: 128,
    name: 'Polygon',
    wsURL: arrayOrString(config.wsUrlOverrides?.polygon) || 'wss://polygon-pos.infrafc.org',
    rpcURL: arrayOrString(config.rpcUrlOverrides?.polygon) || 'https://polygon-pos.infrafc.org',
  ...
  avalanche: {
    ...
    gasLimit: 15_000_000,
    wsURL:
      arrayOrString(config.wsUrlOverrides?.avalanche) ||
      'https://avalanche-mainnet.infrafc.org/ext/bc/C/rpc',
    rpcURL:
      arrayOrString(config.rpcUrlOverrides?.avalanche) ||
      `https://avalanche-mainnet.infrafc.org/ext/bc/C/rpc`,
